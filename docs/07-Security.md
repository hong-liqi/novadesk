...
Definir a estratégia de segurança do Portfolio OS: autenticação, autorização, proteção de dados, comunicação segura, gestão de secrets, threat model e práticas de secure development.
...
| TTL | 15 minutos |
| Issuer | `portfolio-os-auth` |
| Audience | `portfolio-os` |
...
| `guest` | Não autenticado | Portfolio website, registro |
...
| staging | `https://staging.portfolio-os.dev` |
| production | `https://portfolio-os.dev` |
...
|---------------|----------|----------|
| Pública | Portfolio content, docs | Nenhuma especial |
