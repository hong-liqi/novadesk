...
Definir padrões obrigatórios para todas as APIs REST do Portfolio OS: nomenclatura, versionamento, formatos, paginação, erros, autenticação e documentação OpenAPI.
