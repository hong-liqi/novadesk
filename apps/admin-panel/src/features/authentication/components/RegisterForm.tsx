...
export function RegisterForm() {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setError(formatAuthError(err, 'Administrator setup failed'));
    } finally {
      setLoading(false);
    }
  }
  ...
  return (
    <AuthLayout
      title="Set up platform administrator"
      subtitle="Create the first administrator account for this NovaDesk deployment"
    >
      <form
        onSubmit={(event) => {
